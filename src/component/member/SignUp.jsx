        ...
        <div className="sign_up_box">
            ...
            <form action="member/sign_up_confirm" method="post" name="sign_up_form" encType="multipart/form-data">
                ...
                <div className="select_gender">
                    성별선택: &nbsp;
                    <div className="select_m">
                        
                        <input type="radio" name="m_gender" value="M" checked={mGender === 'M'} onChange={genderChangeHandler}/>남자
                        
                    </div>                    
                    <div className="select_f">
                        <input type="radio" name="m_gender" value="F" checked={mGender === 'F'} onChange={genderChangeHandler}/>여자
                    </div>  
                </div>
                
                <div className="filebox">
                    <input className="upload-name" readOnly placeholder="첨부파일"/>
                ...
                <div className="find_password"><a href="#none">비밀번호 찾기</a></div>
            </form>
        </div>
